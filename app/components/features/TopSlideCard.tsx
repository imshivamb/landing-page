    ...
    <div className="card" id={id}>
      ...
      >
        <div className="flex w-full md:w-1/2 flex-col gap-4 items-start justify-start">
          <h4 className=" text-3xl md:text-4xl/normal font-semibold">{title}</h4>
          <p className="text-base/normal font-normal ">{description}</p>
          <Link href={link}>
            <Button text="Get Started" className="text-white bg-gray-800" />
          </Link>
        </div>
        <div className="md:w-1/2 mt-4 md:mt-0 w-full overflow-hidden relative h-full px-10 py-4 max-w-[450px] min-h-[250px]">
          <Image
            fill
            src={image}
            alt="Slider image"
