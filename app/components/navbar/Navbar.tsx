...
const Navbar = () => {
  return (
    <header>
      <div className="nav-wrapper z-[9999] w-full mx-auto pt-6 px-10 block fixed left-0 top-0 bottom-auto right-0">
        <div
          id="nav"
          className="bg-white rounded-2xl mx-auto tracking-tight text-base leading-normal shadow-lg relative block"
        >
